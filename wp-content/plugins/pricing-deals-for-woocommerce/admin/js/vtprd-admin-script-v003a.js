 ...
 */
                          ...
                          function firstTimeThroughControl() {                     
                             ...
                             */
                             ...
                             if ($("#only_for_this_coupon_name").val() == $("#couponMsg").val() ) {
                              ...
                              //v1.1.7.1a begin
                             if ($("#buy_group_varName").val() == $("#varNameMsg").val() ) {
                               jQuery('#buy_group_varName').css('color', 'rgb(152, 152, 152) !important').css("font-style","italic");                          
                             };
                             if ($("#action_group_varName").val() == $("#varNameMsg").val() ) {
                               jQuery('#action_group_varName').css('color', 'rgb(152, 152, 152) !important').css("font-style","italic");                                                     
                             };                              
                             //v1.1.7.1a end
            ...
            //*************************************  
                     ...
                     //         $("#action_group_box").show("slow");  
                            ...
                            function initAllValues() {      
                              ...
                              //v1.1.7.1a Begin
                              var elem = document.getElementById("buy_group_varName");
                              elem.value = $("#varNameMsg").val();//hidden field with lit
                              jQuery('#buy_group_varName').css('color', 'rgb(152, 152, 152) !important').css("font-style","italic");
                              var elem = document.getElementById("action_group_varName");
                              elem.value = $("#varNameMsg").val();//hidden field with lit
                              jQuery('#action_group_varName').css('color', 'rgb(152, 152, 152) !important').css("font-style","italic");                              
                              //v1.1.7.1a end                               
                          ...
                          //    $('.action_amt_type_zero').attr('disabled', true);
                            ...
                            function setWholeStoreOrCartContentsIn() {
                              ...
                              $('#varNameChoiceIn').attr('disabled', true); //v1.1.7.1a
                            };   
                            function setSameAsBuyGroupOnly() {
                              ...
                              $('#varNameChoiceOut').attr('disabled', true); //v1.1.7.1a
                            ...
                            function popChoiceIn_reset() {
                              ...
                              $('#varNameChoiceIn').attr('disabled', false); //v1.1.7.1a                             
                            };
                            function popChoiceOut_reset() {
                              ...
                              $('#varNameChoiceOut').attr('disabled', false); //v1.1.7.1a                            
                            };
                            //KEEP this
            ...
            //Prompt messages for required fields        
                        ...
                        jQuery("#discount_product_full_msg[type=text], #discount_product_short_msg[type=text], #only_for_this_coupon_name[type=text], #only_for_this_coupon_name[type=text], #buy_group_varName[type=text], #action_group_varName[type=text]").focus(function() {   //v1.1.7.1a 
                    ...
                    //			}
                          ...
                          //v1.1.7.1 begin
                          if (id == 'buy_group_varName') {
                    				if (this.value === $("#varNameMsg").val()) {
                              this.value = '';
                            }
                    			} 
                          if (id == 'action_group_varName') {
                    				if (this.value === $("#varNameMsg").val()) {
                              this.value = '';
                            }
                    			}                         
                        ...
                        //FUNCTION - put msg back if nothing is there!!!
                    		jQuery("#discount_product_full_msg[type=text], #discount_product_short_msg[type=text], #only_for_this_coupon_name[type=text], #buy_group_varName[type=text], #action_group_varName[type=text]").blur(function() {   //v1.1.7.1a                 				
                          var id = jQuery(this).attr('id');
                    			if (id == 'discount_product_full_msg') {
                          ...
                          //v1.1.7.1 begin
                          if (id == 'buy_group_varName') {
                    				var default_value = $("#varNameMsg").val();
                    			} 
                          if (id == 'action_group_varName') {
                    				var default_value = $("#varNameMsg").val();
                    			}                          
                             ...
                             function show_selection_panel_J () {     
                              ...
                              switch( $("#popChoiceOut").val() ) {                                
                                ...
                                case "groups":       $(".selection-panel-J-0").show("slow");   break;
								                case "varName":      $(".selection-panel-J-0").show("slow");   break; //v1.1.7.1
     ...
     //end old stuff
            ...
            //********************************************                                                                  
                        ...
                        function popChoiceInProcess() {
                          switch( $("#popChoiceIn").val() ) {
                            ...
                            case "groups":     groupChoiceIn();   break;
							              case "varName":    varNameChoiceIn(); break; //v1.1.7.1
                        ...
                        function cartChoiceIn() {
                          ...
                          $("#buy_group_varName_area").hide();	//v1.1.7.1					  
                        };
                         //v1.1.7.1 begin
                        function varNameChoiceIn() {          					      
          						    groupChoiceIn();
                          $("#buy_group_varName_area").show("slow");
                        };
                        //v1.1.7.1 end						
                        function groupChoiceIn() {
                          ...
                          //v1.1 begin
                          //CHANGE the ID to pick up different CSS 
                          //try all 2 of 3 IDs to change for css...
                          //reg id = role-in
                          //single with vars id = role-in-single-vars
                          //single product id = role-in-single                         
                          var e = document.getElementById("role-in-single");
                          if (e !== null) {
                           e.id = "role-in";		
                          }
                          var f = document.getElementById("role-in-single-vars");
                          if (f !== null) {
                           f.id = "role-in";		
                          }
                          $(".role-in-label-optional").hide("slow");
                          //v1.1 end
                        ...
                        function varChoiceIn() {
                          ...
                          //single with vars id = role-in-single-vars
                          //single product id = role-in-single                         
                          var e = document.getElementById("role-in");
                          if (e !== null) {
                           e.id = "role-in-single-vars";		
                          }
                          var f = document.getElementById("role-in-single");
                          if (f !== null) {
                           f.id = "role-in-single-vars";		
                          }
                          $(".role-in-label-optional").show("slow");
                          //v1.1 end                          
                        };
                        ...
                        function popChoiceOutProcess() {
                          switch( $("#popChoiceOut").val() ) {
                            ...
                            case "groups":       groupChoiceOut();   break;
							              case "varName":      varNameChoiceOut(); break;  //v1.1.7.1
                        ...
                        function cartChoiceOut() {                            
                          ...
                          $("#action_group_line_remainder").hide("slow");
						              $("#action_group_varName_area").hide();	//v1.1.7.1						  
                        };
						            //v1.1.7.1 begin
                        function varNameChoiceOut() {
            						  groupChoiceOut();
            						  $("#action_group_varName_area").show("slow");						  
                        };				
						            //v1.1.7.1 end						
