  ...
  public function vtprd_deal() {     
    ...
    <img id="pricing-deals-img-preload" alt="" src="<?php echo VTPRD_URL;?>/admin/images/upgrade-bkgrnd-banner.jpg" />
      ...
      <div class="display-virtual_box  top-box">                           
        ...
        <input type="hidden" id="varNameMsg" name="varNameMsg" value="<?php echo $vtprd_info['default_by_varname_msg'];?>" />   <?php //v1.1.7.1a  ?>
...
*/           
        ...
        <?php //*****************?>
        <?php //v1.1.7.1a Begin ?>
         <div id="buy_group_varName_area" class="screen-box">  
            <span class="left-column varName-left-column">
                <span class="title  third-level-title  hasWizardHelpRight" id="buy_group_varName_title">
                   <a id="buy_group_varName_anchor" class="title-anchors third-level-title" href="javascript:void(0);"><?php _e('Discount By Variation Name Across Products', 'vtprd');?> </a>
                </span>
                <?php vtprd_show_object_hover_help ('varName', 'wizard') ?>
            </span>
             ...
             <?php
                 ...
                 $varName_string = null;
                 $varName_count = 0;
                 foreach ($vtprd_rule->buy_group_varName_array as $varName) {
                ...
                if ($varName_count == 0) {
                  $varName_string = $vtprd_info['default_by_varname_msg'];
                }
                
                /*
                *******************************
                When checking varname array against product name, change BOTH to lowercase!!!!!!!!
                *******************************
                */
            ?>
            <span id='buy_group_varName_example'>Example:&nbsp;&nbsp;<?php echo $vtprd_info['default_by_varname_example']; ?> </span>
            
            <span class="dropdown buy_repeat right-column buy_group_varName-column" id="buy_group_varName_dropdown">              
               <span class="">
                   <textarea rows="2" cols="50" id="<?php echo $vtprd_rule_display_framework['buy_group_varName']['id']; ?>" class="<?php echo $vtprd_rule_display_framework['buy_group_varName']['class']; ?>  right-column" type="<?php echo $vtprd_rule_display_framework['buy_group_varName']['type']; ?>" name="<?php echo $vtprd_rule_display_framework['buy_group_varName']['name']; ?>" ><?php echo $varName_string; ?></textarea>
                   
               </span>              
               <span class="shortIntro" >
                  <img  class="hasHoverHelp2" width="11px" alt=""  src="<?php echo VTPRD_URL;?>/admin/images/help.png" /> 
                  <?php vtprd_show_object_hover_help ('varName', 'small') ?>
               </span>                               
            </span>
            
            <span id='buy_group_varName_addl_info'> <?php _e('( <em>Changes To &nbsp; lowercase &nbsp; , &nbsp; removes leading and trailing spaces </em>)', 'vtprd'); //v1.1.7.1a ?></span>
             
            <h4 id="buy_group_varName_and">
             - And - &nbsp;&nbsp;&nbsp; Categories &nbsp; , &nbsp; Roles &nbsp;&nbsp;&nbsp; <span class="andOptional" ><em>(optional)</em></span> 
            </h4>

                 
         </div>  <?php //end buy_group_varName_area ?>      
        <?php //v1.1.7.1 End ?>
        <?php //*****************?>
    ...
    ?>                                             
        ...
        <?php //*****************?>
        <?php //v1.1.7.1a Begin ?>
         <div id="action_group_varName_area" class="screen-box">  
            <span class="left-column  varName-left-column">
                <span class="title  third-level-title  hasWizardHelpRight" id="action_group_varName_title">
                   <a id="action_group_varName_anchor" class="title-anchors third-level-title" href="javascript:void(0);"><?php _e('Discount By Variation Name Across Products', 'vtprd');?> </a>
                </span>
                <?php vtprd_show_object_hover_help ('varName', 'wizard') ?>
            </span>
             ...
             <?php
                 $varName_string = null;
                 $varName_count = 0;
                 foreach ($vtprd_rule->action_group_varName_array as $varName) {
                ...
                */
            ?>
            <span id='action_group_varName_example'>Example:&nbsp;&nbsp;<?php echo $vtprd_info['default_by_varname_example']; //v1.1.7.2 corrected ?> </span>
            
            <span class="dropdown buy_repeat right-column action_group_varName-column" id="action_group_varName_dropdown">              
               <span class="">
                   <textarea rows="2" cols="50" id="<?php echo $vtprd_rule_display_framework['action_group_varName']['id']; ?>" class="<?php echo $vtprd_rule_display_framework['action_group_varName']['class']; ?>  right-column" type="<?php echo $vtprd_rule_display_framework['action_group_varName']['type']; ?>" name="<?php echo $vtprd_rule_display_framework['action_group_varName']['name']; ?>" ><?php echo $varName_string; ?></textarea>
            ...
            <span id='action_group_varName_addl_info'> <?php _e('(<em> changes to: all lowercase, removes leading and trailing spaces </em>)', 'vtprd'); //v1.1.7.1a ?></span>
                          
            <h4 id="action_group_varName_and">
             - And - &nbsp;&nbsp;&nbsp; Categories &nbsp;&nbsp;&nbsp; <span class="andOptional" ><em>(optional)</em></span> 
            </h4>

                 
         </div>  <?php //end action_group_varName_area ?>      
        <?php //v1.1.7.1 End ?>
        <?php //*****************?>
