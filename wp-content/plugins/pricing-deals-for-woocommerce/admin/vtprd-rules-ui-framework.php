       ...
       //TOP LEVEL DROPDOWNS
          ...
          'buy_group_filter_select' =>  array ( 
              ...
              'option'  => array(                   
                  ...
                  //v1.1.7.1 begin
				  array (
                    'id'       => 'buy-group-filter-varName',
                    'class'    => '',
                    'value'    => 'varName',
                    'title'    => __('By Variation Name across Products ... (pro only) ...  ', 'vtprd') . '&nbsp;&nbsp;',  //free version
                    'title2'   => __('By Variation Name across Products ... (pro only) ...  ', 'vtprd') . '&nbsp;&nbsp;',   //free version
                    'title3'   => __('By Variation Name across Products (+Cat or Role)', 'vtprd') . '&nbsp;&nbsp;',    //pro version
                    'title4'   => __('By Variation Name across Products (+Cat or Role)', 'vtprd') . '&nbsp;&nbsp;'      //pro version
                   ),
                  //v1.1.7.1 end 				   
                  array (
          ...
          'option'  => array(
              ...
              array (
               ...
               array (
                ...
                'class'    => 'popChoiceInOptions',
                'value'    => 'varName',
                'title'    => __('By Variation Name across Products ... (pro only) ...', 'vtprd') . '&nbsp;&nbsp;',   
                'title2'   => __('By Variation Name across Products ... (pro only) ...', 'vtprd') . '&nbsp;&nbsp;',   //free version
                'title3'   => __('By Variation Name across Products (+Cat or Role)', 'vtprd') . '&nbsp;&nbsp;',    //pro version
                'title4'   => __('By Variation Name across Products (+Cat or Role)', 'vtprd') . '&nbsp;&nbsp;'      //pro version   
               ),				  
